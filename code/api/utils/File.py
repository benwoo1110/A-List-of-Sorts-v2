...
class File:
    ...
    def getContainingFiles(self, filter_:str = "*", withExtension:bool = True, fileObject:bool = True, nested:bool = False) -> dict:
        files = dict()
        for file_ in glob.glob(os.path.join(self.filepath, filter_), recursive=nested):
